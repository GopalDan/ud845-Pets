...
//        String summaryText = cursor.getString(cursor.getColumnIndexOrThrow("breed"));
        //Read the pet attributes from the cursor for the current pet
        String petName = cursor.getString(nameColumnIndex);
        String breedName = cursor.getString(summaryColumnIndex);
